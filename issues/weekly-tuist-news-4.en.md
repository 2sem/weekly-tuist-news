...
**3. The physics of build systems**

A post on Tuist's official blog covering how four things — build graphs, incremental builds, remote caching, and remote execution — improve how fast a build feels. Worth a read if you're wrestling with build times, even if you're not on remote caching or execution yet.
...
### Hands-on notes
I originally wanted to try out the newly added Stress Test feature, but held off since 4.208 hasn't been released yet.
